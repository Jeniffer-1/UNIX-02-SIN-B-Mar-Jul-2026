...
whoami #Who am I?
ls #what's here
ls -l #Displays files and folders in detailed format
ls -la #It makes no difference whether you run ls or ls -la
ls -lh #It makes no difference whether you run ls or ls -lh
ls -lt #when each file was modified
ls / #View all main system folders
ls /etc | head -20 #Shows the first 20 lines
ls /dev | head -20 #It's the same thing ls /etc | head -20 but you would use dev
